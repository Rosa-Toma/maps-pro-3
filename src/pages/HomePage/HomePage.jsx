...
import { useStandard, useNavigation, useMeasure, useSnap, useDrawing, useGuide, useDisplay, useDisplayTab } from "hooks";
...
const HomePage = () => {
    ...
    return (
        <>
            <Sidebar>
                <Section>
                    <Button title="légende" onClick={displayLegendTab} width="90px" height="32px" />
                    <Button title="sélection" onClick={displaySelectionTab} width="90px" height="32px" />
                    <Button title="outils" onClick={displayToolsTab} width="90px" height="32px" />
                    <Button title="localisation" onClick={displayLocalisationTab} width="90px" height="32px" />
                </Section>
                <Section hide={isLegendTabHide}></Section>
                <Section hide={isSelectionTabHide}></Section>
                <Section hide={isToolsTabHide} vertical>
                ...
                <Section hide={isLocalisationTabHide}></Section>
            </Sidebar>
            <Toolbar>
